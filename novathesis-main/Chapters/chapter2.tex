...
\label{cha:avaliacao_usabilidade}
...
% dar uma definição breve logo no inicio
% Fazer a comparação entre perceptual discriminability e visual expression 
% dizer que a visual expression divide o conjunto de variaveis visuais em dois grupos
